...
static inline void ln33_transmit_data(byte area, byte IR_data, byte rail) {
  uint8_t TX_length = 0x08;
  tmpseq[0] = Serial_head;
  tmpseq[1] = TX_length;
  tmpseq[2] = Serial_general_channel;
  tmpseq[3] = Serial_general_channel;
